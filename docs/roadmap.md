...
| **중기 (상의)**   | 투자전문가처럼 상의 — rationale, confidence, 선택지 | R3·R4 **기능은 상당 부분 제공 중**; 다중 TF·엔진 필드·정책은 **지속 밀도 강화** 중 |
...
| 항목           | 내용                                                                                                        |
| ------------ | --------------------------------------------------------------------------------------------------------- |
| R3 시그널 LLM   | rationale·choices·tf_alignment·entry_timing (룰북 경로 $0) — **서비스 가동**; v3.0 **토큰/레이어** 등은 아래 “예정” 참조 |
...
| 엔진-퍼스트 본선  | 트리거 계약·청산 정책 v1.1·크로스-TF 원장·관측/성과 UI·운영 품질 — 요약은 본 문서·architecture 참조                                    |
