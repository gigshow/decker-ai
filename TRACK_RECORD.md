...
| BTCUSDT | 2 | 2 | 3 | 0 | - → barely moved |
| DOGEUSDT | 5 | 1 | 1 | 0 | - → direction correct |
| ETHUSDT | 2 | 2 | 3 | 0 | + → barely moved |
| SOLUSDT | 3 | 2 | 2 | 0 | - → barely moved |
| XRPUSDT | 4 | 2 | 1 | 0 | + → barely moved |
| XYZ_BRENTOILUSD | 2 | 0 | 5 | 0 | + → barely moved |
| XYZ_CLUSD | 4 | 0 | 3 | 0 | + → barely moved |
| XYZ_GOLDUSD | 2 | 2 | 3 | 0 | - → direction wrong |
| XYZ_KR200USD | 2 | 2 | 3 | 0 | - → direction wrong |
| XYZ_NVDAUSD | 0 | 2 | 5 | 0 | - → barely moved |
| XYZ_SILVERUSD | 2 | 3 | 2 | 0 | - → direction wrong |
| XYZ_SP500USD | 0 | 1 | 6 | 0 | - → barely moved |
| XYZ_TSLAUSD | 4 | 0 | 3 | 0 | + → barely moved |
