...
|--------|---------|-------|------|--------|----------------|
| BNBUSDT | 2 | 5 | 1 | 0 | - → direction wrong |
| BTCUSDT | 1 | 3 | 4 | 0 | - → direction wrong |
| DOGEUSDT | 2 | 4 | 2 | 0 | + → direction correct |
| ETHUSDT | 7 | 1 | 0 | 0 | + → direction correct |
| SOLUSDT | 2 | 5 | 1 | 0 | + → direction correct |
| XRPUSDT | 3 | 5 | 0 | 0 | - → direction wrong |
| XYZ_BRENTOILUSD | 1 | 5 | 2 | 0 | + → barely moved |
| XYZ_CLUSD | 4 | 3 | 1 | 0 | + → barely moved |
| XYZ_GOLDUSD | 3 | 2 | 3 | 0 | - → direction correct |
| XYZ_KR200USD | 4 | 3 | 1 | 0 | + → barely moved |
| XYZ_NVDAUSD | 3 | 1 | 4 | 0 | + → barely moved |
| XYZ_SILVERUSD | 2 | 3 | 3 | 0 | - → barely moved |
