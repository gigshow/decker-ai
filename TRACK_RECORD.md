...
| DOGEUSDT | 3 | 1 | 4 | 0 | - → direction correct |
| ETHUSDT | 1 | 4 | 3 | 0 | - → direction correct |
| SOLUSDT | 3 | 4 | 1 | 0 | - → direction correct |
| XRPUSDT | 0 | 4 | 4 | 0 | + → direction wrong |
| XYZ_BRENTOILUSD | 6 | 1 | 1 | 0 | - → direction correct |
| XYZ_CLUSD | 4 | 2 | 2 | 0 | - → direction correct |
| XYZ_GOLDUSD | 3 | 1 | 4 | 0 | - → direction correct |
| XYZ_KR200USD | 3 | 4 | 1 | 0 | + → direction correct |
| XYZ_NVDAUSD | 3 | 1 | 4 | 0 | + → direction correct |
| XYZ_SILVERUSD | 2 | 4 | 2 | 0 | + → direction wrong |
| XYZ_SP500USD | 1 | 0 | 7 | 0 | - → barely moved |
| XYZ_TSLAUSD | 4 | 2 | 2 | 0 | + → direction correct |
