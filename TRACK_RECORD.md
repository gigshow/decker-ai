...
> `hit` / `miss` / `invalidated` = how each morning view scored the evening it was due, on the record. Full daily briefing + self-scoring: [decker-ai.com/briefing](https://decker-ai.com/briefing).
