...
|--------|---------|-------|------|--------|----------------|
| BNBUSDT | 2 | 3 | 3 | 0 | + → direction wrong |
| BTCUSDT | 4 | 0 | 4 | 0 | - → direction correct |
| DOGEUSDT | 2 | 4 | 2 | 0 | + → direction wrong |
| ETHUSDT | 2 | 3 | 3 | 0 | + → direction wrong |
| SOLUSDT | 3 | 3 | 2 | 0 | + → direction wrong |
| XRPUSDT | 6 | 2 | 0 | 0 | + → direction wrong |
| XYZ_BRENTOILUSD | 4 | 0 | 4 | 0 | - → direction correct |
| XYZ_CLUSD | 5 | 2 | 1 | 0 | - → direction correct |
| XYZ_GOLDUSD | 3 | 3 | 2 | 0 | - → direction wrong |
| XYZ_KR200USD | 4 | 3 | 1 | 0 | + → direction wrong |
| XYZ_NVDAUSD | 4 | 1 | 3 | 0 | + → direction wrong |
| XYZ_SILVERUSD | 1 | 4 | 3 | 0 | + → barely moved |
