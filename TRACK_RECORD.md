...
| ETHUSDT | 2 | 2 | 3 | 0 | + → direction correct |
| SOLUSDT | 4 | 3 | 0 | 0 | + → direction correct |
| XRPUSDT | 5 | 2 | 0 | 0 | + → direction correct |
| XYZ_BRENTOILUSD | 4 | 0 | 3 | 0 | - → barely moved |
| XYZ_CLUSD | 5 | 0 | 2 | 0 | + → direction correct |
| XYZ_GOLDUSD | 3 | 1 | 3 | 0 | - → barely moved |
| XYZ_KR200USD | 3 | 1 | 3 | 0 | + → barely moved |
| XYZ_NVDAUSD | 1 | 1 | 5 | 0 | - → barely moved |
| XYZ_SILVERUSD | 3 | 2 | 2 | 0 | - → barely moved |
| XYZ_SP500USD | 0 | 1 | 6 | 0 | + → barely moved |
| XYZ_TSLAUSD | 4 | 1 | 2 | 0 | + → barely moved |
