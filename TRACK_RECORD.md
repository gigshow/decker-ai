...
|--------|---------|-------|------|--------|----------------|
| BNBUSDT | 3 | 0 | 4 | 0 | + → barely moved |
| BTCUSDT | 1 | 5 | 2 | 0 | - → direction wrong |
| DOGEUSDT | 2 | 3 | 2 | 0 | + → direction correct |
| ETHUSDT | 2 | 4 | 2 | 0 | - → direction wrong |
| SOLUSDT | 4 | 3 | 0 | 0 | - → direction wrong |
| XRPUSDT | 4 | 0 | 3 | 0 | - → barely moved |
| XYZ_BRENTOILUSD | 4 | 0 | 2 | 0 | - → direction correct |
| XYZ_CLUSD | 3 | 2 | 1 | 0 | + → barely moved |
| XYZ_GOLDUSD | 1 | 0 | 5 | 0 | + → barely moved |
| XYZ_KR200USD | 3 | 2 | 1 | 0 | + → direction correct |
| XYZ_NVDAUSD | 4 | 0 | 2 | 0 | - → barely moved |
| XYZ_SILVERUSD | 1 | 2 | 3 | 0 | + → barely moved |
| XYZ_SP500USD | 2 | 0 | 3 | 0 | + → barely moved |
