...
|--------|---------|-------|------|--------|----------------|
| BNBUSDT | 4 | 3 | 1 | 0 | + → direction wrong |
| BTCUSDT | 4 | 2 | 2 | 0 | + → direction wrong |
| DOGEUSDT | 3 | 5 | 0 | 0 | + → direction wrong |
| ETHUSDT | 4 | 2 | 2 | 0 | - → direction correct |
| SOLUSDT | 3 | 3 | 2 | 0 | + → direction wrong |
| XRPUSDT | 4 | 4 | 0 | 0 | + → direction wrong |
| XYZ_BRENTOILUSD | 4 | 1 | 3 | 0 | - → direction correct |
| XYZ_CLUSD | 4 | 3 | 1 | 0 | + → direction wrong |
| XYZ_GOLDUSD | 1 | 5 | 2 | 0 | + → direction wrong |
| XYZ_KR200USD | 4 | 3 | 1 | 0 | + → direction correct |
| XYZ_NVDAUSD | 4 | 2 | 2 | 0 | - → barely moved |
| XYZ_SILVERUSD | 0 | 4 | 4 | 0 | - → direction wrong |
| XYZ_SP500USD | 0 | 0 | 8 | 0 | + → barely moved |
| XYZ_TSLAUSD | 4 | 1 | 3 | 0 | + → barely moved |
