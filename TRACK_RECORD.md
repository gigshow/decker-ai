...
|--------|---------|-------|------|--------|----------------|
| BNBUSDT | 2 | 4 | 2 | 0 | - → barely moved |
| BTCUSDT | 1 | 3 | 4 | 0 | - → barely moved |
| DOGEUSDT | 2 | 4 | 2 | 0 | + → direction wrong |
| ETHUSDT | 6 | 1 | 1 | 0 | - → barely moved |
| SOLUSDT | 2 | 4 | 2 | 0 | + → barely moved |
| XRPUSDT | 3 | 4 | 1 | 0 | + → barely moved |
| XYZ_BRENTOILUSD | 2 | 4 | 2 | 0 | + → direction correct |
...
| XYZ_TSLAUSD | 5 | 1 | 2 | 0 | + → direction correct |
