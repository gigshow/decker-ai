...
|------------|-------|--------------------------------------|------------------------|
| 2026-09-25 | 14 views | correct 1 · wrong 4 · flat 2 · pending 2 | BNBUSDT + → in progress, SOLUSDT - → direction wrong, XRPUSDT - → in progress |
| 2026-09-24 | 14 views | correct 5 · wrong 4 · flat 5 | BNBUSDT + → barely moved, BTCUSDT + → direction wrong, DOGEUSDT + → direction correct |
| 2026-09-23 | 14 views | correct 7 · wrong 4 · flat 3 | BNBUSDT + → direction correct, BTCUSDT + → direction correct, DOGEUSDT + → direction correct |
| 2026-09-22 | 14 views | correct 4 · wrong 7 · flat 3 | BNBUSDT + → direction wrong, BTCUSDT - → direction correct, DOGEUSDT + → barely moved |
| 2026-09-21 | 14 views | correct 8 · wrong 5 · flat 1 | BNBUSDT - → direction wrong, BTCUSDT + → direction correct, DOGEUSDT + → direction correct |
| 2026-09-20 | 14 views | correct 5 · wrong 8 · flat 1 | BNBUSDT - → direction correct, BTCUSDT + → direction wrong, DOGEUSDT + → direction wrong |
| 2026-09-19 | 14 views | correct 1 · wrong 4 · flat 9 | BNBUSDT + → direction wrong, BTCUSDT + → barely moved, DOGEUSDT - → barely moved |
| 2026-09-18 | 14 views | correct 8 · wrong 4 · flat 2 | BNBUSDT + → direction correct, BTCUSDT - → direction wrong, DOGEUSDT - → direction wrong |
| 2026-09-17 | 14 views | correct 4 · wrong 10 | BNBUSDT - → direction wrong, BTCUSDT - → direction wrong, DOGEUSDT - → direction wrong |
| 2026-09-16 | 14 views | correct 3 · wrong 7 · flat 4 | BNBUSDT - → barely moved, BTCUSDT - → direction wrong, DOGEUSDT - → barely moved |
| 2026-09-15 | 14 views | correct 3 · wrong 5 · flat 6 | BNBUSDT - → barely moved, BTCUSDT + → direction wrong, DOGEUSDT - → direction correct |
| 2026-09-14 | 14 views | correct 2 · wrong 7 · flat 5 | BNBUSDT - → direction wrong, BTCUSDT - → direction wrong, DOGEUSDT - → direction wrong |
| 2026-09-13 | 14 views | correct 1 · flat 13 | BNBUSDT + → barely moved, BTCUSDT - → barely moved, DOGEUSDT + → barely moved |
| 2026-09-12 | 14 views | correct 4 · wrong 4 · flat 6 | BNBUSDT - → direction wrong, BTCUSDT - → direction wrong, DOGEUSDT + → direction correct |
| 2026-09-11 | 14 views | correct 4 · wrong 3 · flat 7 | BNBUSDT - → barely moved, BTCUSDT - → barely moved, DOGEUSDT - → direction wrong |
| 2026-09-10 | 14 views | correct 5 · wrong 4 · flat 5 | BNBUSDT + → direction correct, BTCUSDT - → direction wrong, DOGEUSDT - → direction wrong |
| 2026-09-09 | 14 views | correct 1 · wrong 4 · flat 9 | BNBUSDT + → direction wrong, BTCUSDT - → barely moved, DOGEUSDT - → direction correct |
| 2026-09-08 | 14 views | correct 6 · wrong 3 · flat 5 | BNBUSDT + → direction correct, BTCUSDT - → barely moved, DOGEUSDT - → direction correct |
| 2026-09-07 | 14 views | correct 6 · wrong 5 · flat 3 | BNBUSDT + → direction wrong, BTCUSDT - → direction correct, DOGEUSDT - → direction correct |
| 2026-09-06 | 14 views | correct 5 · wrong 2 · flat 7 | BNBUSDT + → direction wrong, BTCUSDT - → direction wrong, DOGEUSDT + → direction correct |
| 2026-09-05 | 14 views | correct 3 · wrong 2 · flat 9 | BNBUSDT - → direction wrong, BTCUSDT - → barely moved, DOGEUSDT + → barely moved |
| 2026-09-04 | 14 views | correct 5 · wrong 4 · flat 5 | BNBUSDT + → barely moved, BTCUSDT + → direction wrong, DOGEUSDT + → direction wrong |
| 2026-09-03 | 14 views | correct 8 · wrong 3 · flat 3 | BNBUSDT + → direction correct, BTCUSDT + → direction correct, DOGEUSDT + → direction correct |
| 2026-09-02 | 14 views | correct 6 · wrong 3 · flat 5 | BNBUSDT - → direction wrong, BTCUSDT - → direction wrong, DOGEUSDT - → barely moved |
| 2026-09-01 | 14 views | correct 7 · wrong 3 · flat 4 | BNBUSDT - → direction wrong, BTCUSDT + → barely moved, DOGEUSDT + → direction correct |
| 2026-08-31 | 14 views | correct 6 · wrong 7 · flat 1 | BNBUSDT - → direction correct, BTCUSDT + → direction wrong, DOGEUSDT + → direction wrong |
| 2026-08-30 | 14 views | correct 2 · wrong 2 · flat 10 | BNBUSDT - → direction wrong, BTCUSDT + → barely moved, DOGEUSDT + → barely moved |
| 2026-08-29 | 14 views | correct 4 · wrong 5 · flat 5 | BNBUSDT + → barely moved, BTCUSDT - → direction correct, DOGEUSDT + → direction wrong |
| 2026-08-28 | 14 views | correct 3 · wrong 8 · flat 3 | BNBUSDT + → direction wrong, BTCUSDT + → direction wrong, DOGEUSDT + → direction wrong |
| 2026-08-27 | 14 views | correct 3 · wrong 7 · flat 4 | BNBUSDT - → direction correct, BTCUSDT - → direction wrong, DOGEUSDT - → direction wrong |
| 2026-08-26 | 14 views | correct 7 · wrong 1 · flat 6 | BNBUSDT + → barely moved, BTCUSDT + → direction correct, DOGEUSDT - → direction correct |
| 2026-08-25 | 14 views | correct 6 · wrong 7 · flat 1 | BNBUSDT + → direction correct, BTCUSDT + → direction correct, DOGEUSDT - → direction wrong |
| 2026-08-24 | 14 views | correct 4 · wrong 8 · flat 2 | BNBUSDT + → direction wrong, BTCUSDT - → direction correct, DOGEUSDT + → direction wrong |
| 2026-08-23 | 14 views | correct 3 · wrong 3 · flat 8 | BNBUSDT + → direction wrong, BTCUSDT + → barely moved, DOGEUSDT + → direction wrong |
| 2026-08-22 | 14 views | correct 6 · wrong 2 · flat 6 | BNBUSDT + → direction correct, BTCUSDT + → barely moved, DOGEUSDT + → direction correct |
| 2026-08-21 | 14 views | correct 11 · wrong 2 · flat 1 | BNBUSDT + → direction correct, BTCUSDT + → direction correct, DOGEUSDT + → direction correct |
| 2026-08-20 | 14 views | correct 3 · wrong 3 · flat 8 | BNBUSDT - → barely moved, BTCUSDT + → barely moved, DOGEUSDT + → barely moved |
| 2026-08-19 | 14 views | correct 6 · wrong 1 · flat 7 | BNBUSDT - → barely moved, BTCUSDT - → direction correct, DOGEUSDT + → barely moved |
| 2026-08-18 | 14 views | correct 6 · wrong 6 · flat 2 | BNBUSDT + → barely moved, BTCUSDT + → barely moved, DOGEUSDT + → direction wrong |
...
|--------|---------|-------|------|--------|----------------|
| BNBUSDT | 2 | 3 | 1 | 0 | + → in progress |
| BTCUSDT | 3 | 2 | 1 | 0 | + → direction wrong |
| DOGEUSDT | 3 | 1 | 2 | 0 | + → direction correct |
| ETHUSDT | 2 | 2 | 2 | 0 | + → barely moved |
| SOLUSDT | 2 | 4 | 1 | 0 | - → direction wrong |
| XRPUSDT | 4 | 2 | 0 | 0 | - → in progress |
| XYZ_BRENTOILUSD | 1 | 4 | 1 | 0 | - → direction correct |
| XYZ_CLUSD | 3 | 3 | 0 | 0 | - → direction correct |
| XYZ_GOLDUSD | 1 | 1 | 5 | 0 | - → barely moved |
| XYZ_KR200USD | 1 | 4 | 2 | 0 | - → direction wrong |
| XYZ_NVDAUSD | 3 | 1 | 3 | 0 | - → direction wrong |
| XYZ_SILVERUSD | 3 | 3 | 1 | 0 | - → direction correct |
| XYZ_SP500USD | 2 | 0 | 5 | 0 | - → barely moved |
| XYZ_TSLAUSD | 1 | 6 | 0 | 0 | - → direction wrong |
