...
|--------|---------|-------|------|--------|----------------|
| BNBUSDT | 3 | 1 | 3 | 0 | + → direction wrong |
| BTCUSDT | 1 | 4 | 3 | 0 | + → barely moved |
| DOGEUSDT | 2 | 3 | 2 | 0 | + → direction wrong |
| ETHUSDT | 1 | 4 | 3 | 0 | + → barely moved |
...
| XYZ_KR200USD | 3 | 2 | 1 | 0 | + → direction wrong |
| XYZ_NVDAUSD | 3 | 0 | 3 | 0 | - → barely moved |
| XYZ_SILVERUSD | 1 | 3 | 2 | 0 | + → direction wrong |
| XYZ_SP500USD | 1 | 0 | 4 | 0 | + → barely moved |
| XYZ_TSLAUSD | 2 | 1 | 3 | 0 | + → barely moved |
