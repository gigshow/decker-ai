...
|--------|---------|-------|------|--------|----------------|
| BNBUSDT | 3 | 2 | 3 | 0 | + → direction correct |
| BTCUSDT | 4 | 0 | 4 | 0 | + → direction correct |
| DOGEUSDT | 2 | 4 | 2 | 0 | - → direction wrong |
| ETHUSDT | 2 | 3 | 3 | 0 | + → direction correct |
| SOLUSDT | 4 | 2 | 2 | 0 | + → direction correct |
| XRPUSDT | 6 | 2 | 0 | 0 | + → direction correct |
| XYZ_BRENTOILUSD | 4 | 1 | 3 | 0 | - → direction wrong |
| XYZ_CLUSD | 5 | 3 | 0 | 0 | - → direction wrong |
| XYZ_GOLDUSD | 2 | 4 | 2 | 0 | + → direction wrong |
| XYZ_KR200USD | 4 | 3 | 1 | 0 | + → direction correct |
| XYZ_NVDAUSD | 4 | 2 | 2 | 0 | - → direction wrong |
| XYZ_SILVERUSD | 1 | 4 | 3 | 0 | + → direction wrong |
| XYZ_SP500USD | 0 | 1 | 7 | 0 | - → barely moved |
| XYZ_TSLAUSD | 4 | 1 | 3 | 0 | - → direction wrong |
