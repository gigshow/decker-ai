...
|--------|---------|-------|------|--------|----------------|
| BNBUSDT | 3 | 3 | 2 | 0 | - → direction wrong |
| BTCUSDT | 3 | 3 | 2 | 0 | + → barely moved |
| DOGEUSDT | 2 | 5 | 1 | 0 | + → direction correct |
| ETHUSDT | 4 | 2 | 2 | 0 | + → barely moved |
| SOLUSDT | 3 | 4 | 1 | 0 | - → direction wrong |
| XRPUSDT | 3 | 4 | 1 | 0 | - → direction wrong |
| XYZ_BRENTOILUSD | 4 | 2 | 2 | 0 | + → direction correct |
| XYZ_CLUSD | 4 | 3 | 1 | 0 | + → direction correct |
| XYZ_GOLDUSD | 2 | 4 | 2 | 0 | - → direction correct |
| XYZ_KR200USD | 5 | 2 | 1 | 0 | + → direction correct |
| XYZ_NVDAUSD | 1 | 1 | 6 | 0 | + → barely moved |
| XYZ_SILVERUSD | 1 | 4 | 3 | 0 | + → direction correct |
| XYZ_SP500USD | 0 | 1 | 7 | 0 | - → barely moved |
| XYZ_TSLAUSD | 3 | 2 | 3 | 0 | - → direction correct |
