...
|--------|---------|-------|------|--------|----------------|
| BNBUSDT | 3 | 3 | 2 | 0 | + → barely moved |
| BTCUSDT | 4 | 2 | 2 | 0 | - → direction correct |
| DOGEUSDT | 2 | 6 | 0 | 0 | + → direction wrong |
| ETHUSDT | 4 | 2 | 2 | 0 | - → direction correct |
| SOLUSDT | 2 | 4 | 2 | 0 | + → direction wrong |
| XRPUSDT | 4 | 4 | 0 | 0 | - → direction correct |
| XYZ_BRENTOILUSD | 3 | 2 | 3 | 0 | - → direction wrong |
| XYZ_CLUSD | 3 | 4 | 1 | 0 | - → direction wrong |
| XYZ_GOLDUSD | 1 | 4 | 3 | 0 | + → barely moved |
| XYZ_KR200USD | 3 | 4 | 1 | 0 | - → direction wrong |
| XYZ_NVDAUSD | 3 | 2 | 3 | 0 | - → barely moved |
| XYZ_SILVERUSD | 0 | 3 | 5 | 0 | - → barely moved |
| XYZ_SP500USD | 0 | 0 | 8 | 0 | - → barely moved |
| XYZ_TSLAUSD | 4 | 1 | 3 | 0 | + → direction correct |
