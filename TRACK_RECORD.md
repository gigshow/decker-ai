...
> `verdict` = how a past briefing view scored the evening it was due — `hit` / `miss` / `invalidated`, on the record. Full daily briefing + self-scoring: [decker-ai.com/briefing](https://decker-ai.com/briefing).
