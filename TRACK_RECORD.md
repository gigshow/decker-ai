...
| BTCUSDT | 2 | 3 | 3 | 0 | + → barely moved |
| DOGEUSDT | 1 | 4 | 3 | 0 | + → barely moved |
| ETHUSDT | 2 | 3 | 3 | 0 | - → barely moved |
| SOLUSDT | 3 | 3 | 2 | 0 | + → direction wrong |
| XRPUSDT | 5 | 2 | 1 | 0 | - → direction correct |
| XYZ_BRENTOILUSD | 2 | 2 | 4 | 0 | - → barely moved |
| XYZ_CLUSD | 2 | 2 | 4 | 0 | + → direction wrong |
| XYZ_GOLDUSD | 4 | 1 | 3 | 0 | - → direction correct |
| XYZ_KR200USD | 6 | 1 | 1 | 0 | + → direction correct |
| XYZ_NVDAUSD | 2 | 1 | 5 | 0 | - → barely moved |
| XYZ_SILVERUSD | 2 | 4 | 2 | 0 | - → direction wrong |
| XYZ_SP500USD | 0 | 1 | 7 | 0 | + → barely moved |
| XYZ_TSLAUSD | 2 | 2 | 4 | 0 | - → barely moved |
