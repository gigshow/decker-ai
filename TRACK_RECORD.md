...
| BTCUSDT | 3 | 2 | 3 | 0 | + → direction correct |
| DOGEUSDT | 2 | 3 | 3 | 0 | + → direction correct |
| ETHUSDT | 2 | 3 | 3 | 0 | + → direction correct |
| SOLUSDT | 3 | 3 | 2 | 0 | + → direction correct |
| XRPUSDT | 5 | 2 | 1 | 0 | + → direction correct |
| XYZ_BRENTOILUSD | 3 | 2 | 3 | 0 | + → direction correct |
| XYZ_CLUSD | 3 | 2 | 3 | 0 | + → direction correct |
| XYZ_GOLDUSD | 4 | 2 | 2 | 0 | - → direction wrong |
| XYZ_KR200USD | 6 | 1 | 1 | 0 | + → direction correct |
| XYZ_NVDAUSD | 3 | 0 | 5 | 0 | + → direction correct |
| XYZ_SILVERUSD | 2 | 4 | 2 | 0 | - → direction wrong |
| XYZ_SP500USD | 0 | 1 | 7 | 0 | - → barely moved |
| XYZ_TSLAUSD | 2 | 2 | 4 | 0 | + → direction correct |
