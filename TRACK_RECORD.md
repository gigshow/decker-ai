...
|--------|---------|-------|------|--------|----------------|
| BNBUSDT | 2 | 2 | 4 | 0 | + → direction correct |
| BTCUSDT | 1 | 4 | 3 | 0 | + → direction correct |
| DOGEUSDT | 2 | 2 | 4 | 0 | + → direction correct |
| ETHUSDT | 0 | 5 | 3 | 0 | - → direction wrong |
| SOLUSDT | 2 | 5 | 1 | 0 | + → barely moved |
| XRPUSDT | 1 | 3 | 4 | 0 | + → barely moved |
| XYZ_BRENTOILUSD | 6 | 1 | 1 | 0 | - → direction correct |
| XYZ_CLUSD | 4 | 2 | 2 | 0 | - → direction correct |
| XYZ_GOLDUSD | 2 | 1 | 5 | 0 | + → direction wrong |
